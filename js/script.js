...
function advices(){
  ...
  if(this.checkFields()){
    ...
    if(!checkLiters){
      ...
      document.getElementById("advices").innerHTML +=
      "<p class= 'bg-white' style= 'color:red;'>"+fishes.records[parseInt(idFish)].nombreComun+" - "+fishes.records[parseInt(idFish)].id+"</p>";
    }
  }else{
